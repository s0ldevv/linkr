-- Make secretpanel metadata testing URL saves forgiving for common admin input.
--
-- Operators often paste linkr.cash, x.com/... or t.me/... without a scheme.
-- Normalize those to HTTPS, keep blank optional fields null, and treat bare
-- Telegram hosts as unset instead of raising an internal Edge Function error.
