-- Tighten the schedule mutation RPC used by dashboard and Agent API controls.
-- This keeps backend behavior aligned with the Edge function patch builder:
-- priority updates are applied, and nullable end/max-occurrence fields can be
-- cleared intentionally by sending JSON null.
