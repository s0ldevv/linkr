  ...
  return [
    {
      ...
      chainShortLabel: "EVM",
      chainTone: "robinhood",
      command: "@linkrbot launch $NOVA with 2.4 ETH",
    ...
    },
    {
      ...
      chainShortLabel: "SOL",
      chainTone: "solana",
      command: "@linkrbot buy 0.8 SOL of $RUSH",
    ...
    },
    {
      ...
      chainShortLabel: "SOL",
      chainTone: "solana",
      command: "@linkrbot launch $WAVE on Solana",
    ...
    },
    {
      ...
      chainShortLabel: "EVM",
      chainTone: "robinhood",
      command: "@linkrbot prepare launch $PIXEL",
